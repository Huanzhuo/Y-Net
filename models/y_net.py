...
class TCNSeparationBlock(nn.Module):
    ...
    def __init__(self, cfg, i):
        ...
        self.inter_block = BottleneckTCN(ch_inter, ch_inter_mid, ch_inter, x, skip=self.skip)
        self.intra_block = BottleneckTCN(ch_intra, ch_intra_mid, ch_intra, x, skip=self.skip)
...
class Decoder(nn.Module):
    ...
    def forward(self, mixtures, masks):
        ...
        mask_inter = torch.sigmoid(self.mask_inter(mask_inter)).view(batch_size, self.num_spk, self.ch1, -1)
